      ...
      <div className="md:min-w-[710px] w-full max-w-[900px]">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 justify-center">
            <div className="border-1 border-black w-full h-full md:h-[346px] p-4 transition-all duration-400 ease-in-out hover:border-green-600 rounded-md bg-slate-800">
            ...
            <div className="border-1 border-black w-full h-full md:h-[346px] md:overflow-hidden md:hover:h-[100%] p-4 transition-all duration-300 ease-in hover:border-green-600 rounded-md bg-slate-800">
              <FaLaptopCode size={32} color="#00a63e" className="mb-2" />
          ...
          <div>
            ...
            <p>
              ...
              determination. But like many dreams, it eventually met reality,
              and I found myself searching for something else that could ignite
              that same level of passion and purpose. <br /> I pursued a degree
              in Sports Exercise and Science, then moved into the construction
              ...
              work, and my curiosity helped me grow fast. But even then,
              something was missing. <br /> It wasn’t until I discovered web
              development that things started to click. Whether I was building
              out projects or learning a new framework, I felt fully engaged,
              the same way I once did on the court. Coding gave me that sense of
              curiosity, focus, and fulfillment I had been looking for. It’s
              more than a skillset to me, it’s a career I genuinely love doing,
              day in and day out.
            </p>
          </div>
        </div>
