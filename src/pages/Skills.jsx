    ...
    <>
      ...
      >
        <div className="gap-10 flex flex-col">
          ...
          <div className="flex flex-row justify-center z-1 items-center font-bold text-lg">
            <button
                      ...
                      >
                        ...
                        <div className="relative w-full h-2">
                          ...
                          <span
                            ...
                            style={{
                              width: refresh && `${Number(skill.score)}%`,
                            }}
                          ></span>
                        </div>
                      </div>
        ...
        {/* <h1
      className={`transition-all duration-400 ease-in-out ${
        isCli ? "opacity-100 sm:h-full w-full z-50" : "opacity-0 h-0 z-0"
      }`}
    >
      {isCli ? (
        <CLI
      ...
      <div
        className={`transition-all duration-600 ease-in-out ${
          isCli ? "opacity-100 w-full z-50" : "opacity-0 h-0 z-0"
        }`}
      >
        {isCli ? (
          <CLI
